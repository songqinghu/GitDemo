...
CREATE TABLE `prepic` (
  ...
  `pictype` bigint(2) DEFAULT NULL comment '图片类型,依赖图片类型表',
...
CREATE TABLE `mainpic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15218 DEFAULT CHARSET=utf8;
...
CREATE TABLE `imagetype` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16363 DEFAULT CHARSET=utf8;
